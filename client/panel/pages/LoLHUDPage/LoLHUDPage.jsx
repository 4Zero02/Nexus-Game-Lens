...
import './LoLHUDPage.css';

export default function LoLHUDPage() {
  return (
    <div className="lol-page">
      <div className="page-header">
        <h2 className="page-title">League of Legends HUD</h2>
      ...
      <div className="card">
        ...
        <p className="integration-text">
          ...
          League of Legends is running. No manual setup required.
        </p>
      </div>
      ...
      <div className="card">
        ...
        <div className="url-box">http://localhost:8765/output/lol-hud</div>
